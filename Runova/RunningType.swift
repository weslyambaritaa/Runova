                            ...
                            VStack(alignment: .trailing, spacing: 20) {
                                Button(action: {
                                    ...
                                    RoundedRectangle(cornerRadius: 15)
                                        ...
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 15)
                                                .stroke(userData.runningType == "SlowJog" ? .blue : .gray, lineWidth: 3)
                                        )
                                        .offset(y: userData.runningType == "SlowJog" ? -0.1 : 0)
                                        .scaleEffect(userData.runningType == "SlowJog" ? 1.01 : 1.0)
                                        .animation(.easeInOut(duration: 0.3), value: userData.runningType)
                                }
                                
                                
                                Button(action: {
                                    userData.runningType = "EasyRun"
                                    userData.MET = 3.75
                                }) {
                                    RoundedRectangle(cornerRadius: 15)
                                        .fill(Color.white)
                                        ...
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 15)
                                                .stroke(userData.runningType == "EasyRun" ? .blue : .gray, lineWidth: 3)
                                        )
                                        .offset(y: userData.runningType == "EasyRun" ? -0.1 : 0)
                                        .scaleEffect(userData.runningType == "EasyRun" ? 1.01 : 1.0)
                                        .animation(.easeInOut(duration: 0.3), value: userData.runningType)
                                }
                                
                                
                                Button(action: {
                                    userData.runningType  = "ModerateRun"
                                    userData.MET = 6
                                }) {
                                    RoundedRectangle(cornerRadius: 15)
                                        .fill(Color.white)
                                        ...
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 15)
                                                .stroke( userData.runningType  == "ModerateRun" ? .blue : .gray, lineWidth: 3)
                                        )
                                        .offset(y:  userData.runningType  == "ModerateRun" ? -0.1 : 0)
                                        .scaleEffect( userData.runningType  == "ModerateRun" ? 1.01 : 1.0)
                                        .animation(.easeInOut(duration: 0.3), value:  userData.runningType )
                                }
                                
                                
                                Button(action: {
                                    userData.runningType  = "FastRun"
                                    userData.MET = 9.5
                                }) {
                                    RoundedRectangle(cornerRadius: 15)
                                        .fill(Color.white)
                                        ...
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 15)
                                                .stroke( userData.runningType  == "FastRun" ? .blue : .gray, lineWidth: 3)
                                        )
                                        .offset(y:  userData.runningType  == "FastRun" ? -0.1 : 0)
                                        .scaleEffect( userData.runningType  == "FastRun" ? 1.01 : 1.0)
                                        .animation(.easeInOut(duration: 0.3), value:  userData.runningType )
                                }
                                
                                
                                Button(action: {
                                    userData.runningType  = "IntenseRun"
                                    userData.MET = 11
                                }) {
                                    RoundedRectangle(cornerRadius: 15)
                                        .fill(Color.white)
                                        ...
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 15)
                                                .stroke( userData.runningType  == "IntenseRun" ? .blue : .gray, lineWidth: 3)
                                        )
                                        .offset(y:  userData.runningType  == "IntenseRun" ? -0.1 : 0)
                                        .scaleEffect( userData.runningType  == "IntenseRun" ? 1.01 : 1.0)
                                        .animation(.easeInOut(duration: 0.3), value:  userData.runningType )
                                }
